> **English version.** The maintained README is the Vietnamese [README.md](README.md); this copy is kept for readers who prefer English and may lag behind it.
...
for schema and migrations, Docker Compose to run the whole thing, and 224 tests that run
...
**224 tests, all against a real PostgreSQL database.** Not a mock — this project's correctness
